...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Enter Artist Name">
      <input type="email" name="email" title="Enter email in abc@gmail.com pattern" required placeholder="Enter Your Email">
      <input type="text" maxlength="10" name="phone"  pattern="\d{10}" title="Please enter 10 digit phone number" required placeholder="Enter Contact" />

      <input type="text" name="genre" required placeholder="Enter Genre of Music">

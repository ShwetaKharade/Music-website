  ...
  <table class="table ">
    <thead>
      <tr>
        ...
        <th class="text-center">Song Description</th>
        <th class="text-center">Song Category</th>
    ...
    <tr>
      ...
      <td><audio controls><source src="<?=$row["songs"]?>" type="audio/mpeg"> </audio></td>     
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
                <label for="songfile">Choose Song:</label>
                <input type="file" class="form-control-file" id="songfile">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" id="upload" style="height:40px">Add Song</button>
            </div>
          </form>

...
<body >
    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card">
                    <i class="fa fa-th-large mb-2" style="font-size: 70px; color:#fff;"></i>
            ...
            <div class="col-sm-3">
            <div class="card">
                    <i class="fa fa-th mb-2" style="font-size: 70px; color:#fff;"></i>
            ...
            <div class="col-sm-3">
                <div class="card">
                    <i class="fa fa-list mb-2" style="font-size: 70px; color:#fff;"></i>
